...
public class NamedCategoryTest {
	...
	public void testAllDescendantsPreOrder() {
		...
		List<NamedCategory> preOrderList = Lists.newArrayList(root.linearize(TraversalPolicy.topDownTraversalPolicy(SearchStrategy.PRE_ORDER, DuplicatesDetection.IGNORE)));
	...
	public void testAllDescendantsPostOrder() {
		NamedCategory root = newPackagePropertiesRoot().getCategory(packageP1);
		List<NamedCategory> postOrderList = Lists.newArrayList(root.linearize(TraversalPolicy.topDownTraversalPolicy(SearchStrategy.POST_ORDER, DuplicatesDetection.IGNORE)));
	...
	public void testAllDescendantsBreadthFirst() {
		NamedCategory root = newPackagePropertiesRoot().getCategory(packageP1);
		List<NamedCategory> breadthFirstList = Lists.newArrayList(root.linearize(TraversalPolicy.topDownTraversalPolicy(SearchStrategy.BREADTH_FIRST, DuplicatesDetection.IGNORE)));
